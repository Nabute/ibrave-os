...
Internal platform for a 10–50 person outsourcing company. Phases 1–2 of the
[blueprint](docs/outsourcing-automation-blueprint.md) are implemented:
**core + time tracking** (weekly grid, submit → approve → reject workflow) and
**billing** (versioned rate cards, draft invoice generation, issue/void/credit
notes, payments, dunning), plus the My Day workspace and reports.
